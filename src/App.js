            ...
            <p className="fsize-2 text-start f-barlow-400 white mt-2">From Any to Any asset per one transaction</p>
                    ...
                    (
                        <div className='col-4 pt-5'>
                            ...
                            <div className='row d-flex align-items-center justify-content-start m-0 p-0 mt-4'>
                                ...
                                <div className='col-8'>
                                    <a href="https://t.me/split_protocol" target="_blank" className='buttonSocial w-100  px-2 d-flex align-items-center justify-content-center'>
                ...
                >
                            ...
                            <div className='row d-flex align-items-center justify-content-between m-0 p-0 mt-2'>
                                ...
                                <div className='col-8'>
                                    <a href="https://discord.com/invite/Qvn4t7x6VY" target="_blank" className='buttonSocial w-100  px-2 d-flex align-items-center justify-content-center'>
