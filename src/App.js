      ...
      <div className={isMobile ? ('mt-3'): ('row mt-5')}>
        ...
        {isMobile ? null: (
          <div className='col-2 ms-5 mt-5'>
            ...
            {/* item 1 */}
            <div className='d-flex flex-column leftMenuButton mt-5' 
              onClick={() => {
                setMenuItemSelect('item0')
                hideCurrentSlaid(CurrentSlaid)
                setSlaid('slaid0')}}
            >
              <p className='text-start leftMenuItemSelect p-0 m-0 f-barlow-700' id='item0'>{'Limex'}</p>
            </div>

            {/* item 2 */}
            <div className='d-flex flex-column leftMenuButton mt-4' 
              onClick={() => {
                setMenuItemSelect('_item1')
                hideCurrentSlaid(CurrentSlaid)
                setSlaid('slaid1')}}>
            ...
            {/* item 3 */}
            <div 
              className='d-flex flex-column leftMenuButton mt-4'  
              onClick={() => {
                setMenuItemSelect('item2')
                hideCurrentSlaid(CurrentSlaid)
                setSlaid('slaid2')
        ...
        {isMobile ? null: (<div className='col-5'>
          ...
          <div className='slaidnext'>
            <img src={slaidNext} id='imgslaidnext'/>
          </div>
        </div>)}
        ...
        {isMobile ? (
          ...
          <div id="myCarousel" class="carousel slide " data-bs-interval="false" data-bs-touch="true">
            <div className='row p-0 m-0 d-flex justify-content-between'>
              <button className='buttonCarouselM col-6 d-flex justify-content-start p-0 m-0 ps-4'  type="button" data-bs-target="#myCarousel" data-bs-slide="prev">
                <p className='text-start fsize-3w leftMenuItemSelect p-0 m-0 f-barlow-700' id='item0'>{arrMenuItemSlaids[curMenuItemM]}</p>
              </button>
              
              <button 
                className='buttonCarouselM col-6 d-flex justify-content-start p-0 m-0' 
                type="button" 
                ...
                // }}
              >
                <p className='text-start fsize-3w leftMenuItem p-0 m-0 f-barlow-700 me-1' id='_item1'>{arrMenuItemSlaids[nextMenuItemM]}</p>
              </button>
            </div>
            ...
            <div class="carousel-inner position-relative">
              ...
              <div class="carousel-item active" data-bs-interval="10000">
                <div className='slaidM ms-5 mt-4' id='slaid0'>
                  <p className="fsize-4 text-start f-glory white m-0 p-0">Multi-Chain arbitrage</p>
                  <p className="fsize-4 text-start f-glory white m-0 p-0">DEX Aggregator</p>
                  <p className="fsize-2 text-start f-barlow-400 white mt-2">With limit order tools and gasless trades</p>
                </div>
        ...
        {isMobile ? (
          <div className='p-0 m-0 ps-4 pe-4 mt-4'>
            <p className='text-start white fsize-3 m-0 p-0 f-barlow-700'>Join to whitelist</p>
            <p className='text-start white fsize-2 m-0 p-0 f-barlow-400'>Subscribe to our social</p>

            <div className='row d-flex align-items-center justify-content-between m-0 p-0 mt-2'>
              <svg className='col-1 m-0 p-0' width="36" height="34" viewBox="0 0 36 34" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <input className='input-social col-10 ms-2 f-barlow-400 h-5h' placeholder='youre @nickname'>
              </input>
            </div>
            <div className='row d-flex align-items-center justify-content-between m-0 p-0 mt-3'>
              <svg className='col-1 m-0 p-0' width="36" height="32" viewBox="0 0 36 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='row d-flex align-items-center justify-content-between m-0 p-0 mt-3'>
              <svg className='col-1 m-0 p-0' width="36" height="28" viewBox="0 0 36 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        (
          <div className='col-4'>
            ...
            <div className='row d-flex align-items-center justify-content-between m-0 p-0 mt-5'>
              <svg className='col-1 m-0 p-0' width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='row d-flex align-items-center justify-content-between m-0 p-0 mt-3'>
              <svg className='col-1 m-0 p-0' width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
