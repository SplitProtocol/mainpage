...
function App() {
    ...
    let placeMenuItem = [1, 2, 3, 4, 5, 6, 7, 8]
    let movesDic = {
    ...
    function moveMenuDown() {
        ...
        let item = document.getElementById(placeMenuItem[7])
    ...
    function moveMenuUpStep(step) {
        console.log('step', step, placeMenuItem)
        ...
        for (let i = 0; i < 8; i++) {
            if ((i + step - 1) > 7) {
                console.log('i + step - 1 - 7', i + step - 1 - 8)
                placeMenuItem[i] = arr[i + step - 1 - 8]
            }
            else {
    ...
    function clickArrowTop() {
        ...
        if (curNumSlaid === '2') {
            ...
            console.log('next_num_slaid', next_num_slaid)
    ...
    function clickArrowDown() {
        ...
        let num_slaid = parseInt(curNumSlaid)
        let next_num_slaid = num_slaid + 1
        if (next_num_slaid === 8) { next_num_slaid = 0 }
    ...
    return (
        <div className={isMobile ? "AppM" : isOrientaionH ? 'AppH' : "App"} >
            ...
            <div
                ...
                <div className={isMobile ?
                    ...
                    <div className={isMobile || isOrientaionH ?
                        ...
                        <div className="col-2 d-flex justify-content-center p-0 m-0 Logo">
                            <a href="https://medium.com/@split.protocol" target="_blank" rel="noreferrer">
                                <MediumLogo />
                            </a>
                        </div>

                        <div className={isMobile ?
                            ('col-2 d-flex justify-content-center align-items-center p-0 m-0 Logo') :
                            ('col-2 d-flex justify-content-center align-items-center Logo')}>
                            <a href="https://split-docs.gitbook.io/docs/" target="_blank" rel="noreferrer">
                                <GitbookLogo />
                            </a>
                        </div>

                        <div className='col-2 d-flex justify-content-center p-0 m-0 Logo'>
                            <a href="https://github.com/SplitProtocol" target="_blank" rel="noreferrer">
                ...
                {isMobile ? null : (
                  ...
                  >
                    <p className='text-start leftMenuItem p-0 m-0 f-barlow-700' id='item6'>{'Split Relayer'}</p>
                                    ...
                                    >
                                        <p className='text-start leftMenuItem p-0 m-0 f-barlow-700' id='item7'>{'Aggregation'}</p>
                                        {/* <p className='text-start leftMenuItem p-0 m-0 f-barlow-700' id='_item40'>{'something'}</p> */}
                                    </div>
                                </div>
                            </div>
            ...
            <p className="fsize-2 text-start f-barlow-400 white mt-2">From Any to Any asset per one transaction</p>
                    ...
                    <>
                        <div id="myCarousel" class="carousel slide " data-bs-ride="carousel" data-bs-interval="false" data-bs-touch="true">
                            <div className='row p-0 m-0 d-flex justify-content-between menuM'>
                                <button
                                    className='buttonCarouselM col-6 d-flex justify-content-end p-0 m-0 ps-2 '
                                    type="button"
                                    data-bs-target="#myCarousel"
                                    data-bs-slide="prev"
                                    id='buttonMenuM1'
                                >
                                    <p className='text-start fsize-16 leftMenuItemSelect p-0 m-0 me-2 f-barlow-700' >{arrMenuItemSlaids[curMenuItemM]}</p>
                                </button>

                                <button
                                    className='buttonCarouselM col-6 d-flex justify-content-end p-0 m-0 '
                                    type="button"
                                    data-bs-target="#myCarousel"
                                    data-bs-slide="next"
                                    id='buttonMenuM2'
                                >
                                    <p className='text-start fsize-16 leftMenuItem p-0 m-0 me-2 f-barlow-700'>{arrMenuItemSlaids[nextMenuItemM]}</p>
                                </button>
                            </div>
                        ...
                        <div className='col-4 pt-5'>
                            ...
                            <form className="form">
                                <div className="line form__line">
                                    <p>Tokens count</p>
                                    <p>
                                        Token price <span>0,05$</span>
                                    </p>
                                </div>
                                <label className="form-label line">
                                    <input type="text" className="input" />
                                    <div className="input__token-value">
                                        150000 SPLX
                                    </div>
                                </label>
                                <div className="line">
                                    <ul className="options">
                                        {options.map((option, index) => (
                                          <li className={`option__item ${index === activeOption ? 'option__item--active' : ''}`} key={option.title} onClick={showActiveOption} data-index={index}>
                                              {option.title}
                                          </li>
                                        ))}
                                    </ul>
                                    <div className="lock-time-title" >
                                        <p>Lock</p> <span>6 month</span>
                                    </div>
                                </div>
                                <ul className="choose-currency">
                                    {currencies.map((currency, index) => (
                                      <li className={`currency ${index === activeCurrency ? 'currency__item--active' : ''}`} key={currency.title} onClick={showActiveCurrency} data-index={index}>
                                ...
                                <div className="wrapper-button">
                                    <button className="form__button">Buy SPLX</button>
                                </div>
                                <div className="deposits">
                                    <h3 className="deposits__title">Deposits</h3>
                ...
                {/*</input> *!/*/}
                {/*                <div className='col-8'>*/}
                {/*                    <a href="https://t.me/split_protocol" target="_blank" className='buttonSocial w-100  px-2 d-flex align-items-center justify-content-center' rel="noreferrer">*/}
                ...
                {/*                <div className='col-8'>*/}
                {/*                    <a href="https://twitter.com/SplitProtocol" target="_blank" className='buttonSocial w-100  px-2 d-flex align-items-center justify-content-center' rel="noreferrer">*/}
