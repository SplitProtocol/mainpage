      ...
      <div className={isMobile ? ('mt-3'): ('row mt-5')}>
        ...
        {isMobile ? null: (<div className='col-5'>
          ...
          <div className='slaidHide' id='slaid1'>
            <img className='rounded' src={slaid1} />
          </div>
          
          {/* slaid2 */}
          <div className='slaidHide' id='slaid2'>
            <img className='rounded' src={slaid2} />
          </div>

          {/* slaid3 */}
          <div className='slaidHide' id='slaid3'>
            <img className='rounded' src={slaid3} />
          </div>

          {/* slaid4 */}
          <div className='slaidHide' id='slaid4'>
            <img className='rounded' src={slaid4} />
          </div>

          {/* nextSlaid */}
          <div className='slaidnext'>
            <img className='rounded' src={slaidNext} id='imgslaidnext'/>
          </div>
        </div>)}
            ...
            <div class="carousel-inner position-relative">
              ...
              <div class="carousel-item active" data-bs-interval="10000">
                <div className='slaidM ms-3 mt-4' id='slaid0'>
                  <p className="fsize-5 text-start f-glory white m-0 p-0">Multi-Chain arbitrage</p>
                  <p className="fsize-5 text-start f-glory white m-0 p-0">DEX Aggregator</p>
