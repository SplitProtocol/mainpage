...
export function MobForm() {
    ...
    const handleClickAnnouncements = () => {
        window.open('https://t.me/split_protocol', '_blank').focus();
    }
    ...
    const handleClickDiscord = () => {
        window.open('https://discord.com/invite/Qvn4t7x6VY', '_blank').focus();
    }
    ...
    return (
        <>
            ...
            {/*</div> *!/*/}
            {/*</div>*/}
            <div className="wrapper-mobile-btn">
                <button className="form__button light-button" onClick={() => setOpenModal(true)}>Stake</button>
            </div>
            <div className={`modal ${openModal ? "show-modal" : ""}`}>
                ...
                <div className="modal__content">
                        ...
                        <div className="line mobile-line">
                            <p className='text-start white fsize-24 mb-0 p-0 f-barlow-700 title-mobile'>Become the stakeholder</p>
                        ...
                        <form className="form">
                            ...
                            <div className="line line-options-lock">
