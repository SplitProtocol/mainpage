  ...
  const showActiveCurrency = e => setActiveCurrency(+e.target.dataset.index);
    ...
    return (
        <>
          ...
          {/*    </svg>*/}
          {/*    <div className='col-10'>*/}
          {/*      <a href="https://twitter.com/split_finance" target="_blank" className='buttonSocialH w-100  px-2 d-flex align-items-center justify-content-center'>*/}
          ...
          <div className='wrapper-mobile-H'>
