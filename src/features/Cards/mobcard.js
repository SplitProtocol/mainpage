...
export function MobCard(props) {
    ...
    return (
        <>
            <p className="fsize-32 text-start f-barlow-700 white ms-2 m-0 p-0 ws lh-sm">{cardTitle}</p>
            <p className="fsize-16 text-start f-barlow-400 white ms-2 mt-5 ws lh-sm">{cardText}</p>
